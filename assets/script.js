...
(function() {
  ...
  // ==========================================================================
  // Blog search — navigue vers tag.html?q=<terme>
  // ==========================================================================
  ...
  if (searchInput && searchButton) {
    function navigateSearch() {
      ...
      if (q) { window.location.href = 'tag.html?q=' + encodeURIComponent(q); }
    }
...
(function () {
  ...
  var EN = {
    ...
    'svc.s7.num':        'Service 07',
    'svc.s7.title':      'Citizenship Application',
    'svc.s7.desc.long':  'Eligibility check (1,095 days of physical presence), application preparation, avoiding common mistakes, and preparation for the citizenship test for permanent residents on the path to naturalization.',
    ...
    // --- Contact — placeholders + options du select service -----------------
    'contact.form.name.placeholder':  'Your full name',
    'contact.form.msg.placeholder':   'Briefly describe your situation and immigration project...',
    'contact.form.svc.opt0':          '— Select —',
    'contact.form.svc.opt1':          'Permanent residence',
    'contact.form.svc.opt2':          'Study permit',
    'contact.form.svc.opt3':          'Work permit',
    'contact.form.svc.opt4':          'Visitor visa / eTA',
    'contact.form.svc.opt5':          'Sponsorship / family reunification',
    'contact.form.svc.opt6':          'Foreign workers (employer)',
    'contact.form.svc.opt7':          'Asylum claim — RPD',
    'contact.form.svc.opt8':          'Asylum claim appeal — RAD',
    'contact.form.svc.opt9':          'Immigration detention — ID',
    'contact.form.svc.opt10':         'Immigration appeals — IAD',
    'contact.form.svc.opt11':         'Other / I\'m not sure',

    // --- Options communes (réutilisées sur plusieurs selects) ---------------------
    'opt.choose':                     '— Choose —',
    'opt.lt1yr':                      'Less than one year',
    'opt.1yr':                        '1 year',
    'opt.2yr':                        '2 years',
    'opt.3yr':                        '3 years',
    'opt.4yr':                        '4 years',
    'opt.5yrplus':                    '5 years or more',
    'opt.1to2yr':                     '1 to 2 years',
    'opt.3yrplus':                    '3 years or more',
    'opt.3to5yr':                     '3 to 5 years',
    'opt.6yrplus':                    '6 years or more',

    // --- Calculateur de coûts — options type de demande ----------------------
    'calc.costs.opt.visa':            'Visitor visa (TRV)',
    'calc.costs.opt.ave':             'Electronic Travel Authorization (eTA)',
    'calc.costs.opt.etudes':          'Study permit',
    'calc.costs.opt.travail':         'Work permit',
    'calc.costs.opt.rp_eco':          'Economic permanent residence (EE, QSWP)',
    'calc.costs.opt.parrainage':      'Spouse sponsorship',
    'calc.costs.opt.parrainage_parents': 'Parents / grandparents sponsorship',
    'calc.costs.opt.super_visa':      'Super Visa',

    // --- Calculateur d'éligibilité — options selects --------------------------
    'calc.elig.opt.edu.sec':          'Secondary school (high school)',
    'calc.elig.opt.edu.dec':          'Trade or college diploma (DEP, AEC, DEC, 1-year program)',
    'calc.elig.opt.edu.bac':          'Bachelor\'s degree (3–4 years university)',
    'calc.elig.opt.edu.master':       'Master\'s degree',
    'calc.elig.opt.edu.doc':          'Doctorate',
    'calc.elig.opt.lang.none':        'None or very weak',
    'calc.elig.opt.fr.inter':         'Intermediate (B1-B2)',
    'calc.elig.opt.fr.adv':           'Advanced (C1)',
    'calc.elig.opt.fr.sup':           'Upper advanced (C2)',
    'calc.elig.opt.en.inter':         'Intermediate (CLB 5-6)',
    'calc.elig.opt.en.adv':           'Advanced (CLB 7-8)',
    'calc.elig.opt.en.sup':           'Upper advanced (CLB 9+)',
    'calc.elig.opt.stat.abroad':      'No, I am abroad',
    'calc.elig.opt.stat.student':     'Yes, with a study permit',
    'calc.elig.opt.stat.worker':      'Yes, with a work permit',
    'calc.elig.opt.stat.visitor':     'Yes, with visitor status',
    'calc.elig.opt.stat.none':        'Yes, but without valid status',
    'calc.elig.opt.qc.oui':           'Yes, in Quebec',
    'calc.elig.opt.qc.non':           'No, in another province',
    'calc.elig.opt.qc.indecis':       'Not decided yet',

    // --- Calculateur CRS (Entrée express) — options --------------------------
    'crs.opt.single':                 'Single / No accompanying spouse',
    'crs.opt.spouse':                 'With accompanying spouse (married or common-law)',
    'crs.opt.age.under18':            'Under 18',
    'crs.opt.age.18':                 '18 years old',
    'crs.opt.age.19':                 '19 years old',
    'crs.opt.age.20to29':             '20 to 29 years old',
    'crs.opt.age.30':                 '30 years old',
    'crs.opt.age.31':                 '31 years old',
    'crs.opt.age.32':                 '32 years old',
    'crs.opt.age.33':                 '33 years old',
    'crs.opt.age.34':                 '34 years old',
    'crs.opt.age.35':                 '35 years old',
    'crs.opt.age.36':                 '36 years old',
    'crs.opt.age.37':                 '37 years old',
    'crs.opt.age.38':                 '38 years old',
    'crs.opt.age.39':                 '39 years old',
    'crs.opt.age.40':                 '40 years old',
    'crs.opt.age.41':                 '41 years old',
    'crs.opt.age.42':                 '42 years old',
    'crs.opt.age.43':                 '43 years old',
    'crs.opt.age.44':                 '44 years old',
    'crs.opt.age.45plus':             '45 or older',
    'crs.opt.edu.none':               'Less than high school diploma',
    'crs.opt.edu.sec':                'High school diploma',
    'crs.opt.edu.post1':              'Post-secondary — 1 year (diploma, certificate)',
    'crs.opt.edu.post2':              'Post-secondary — 2 years',
    'crs.opt.edu.bac':                'Bachelor\'s degree (3-year program or more)',
    'crs.opt.edu.two':                'Two or more degrees (at least one 3 years+)',
    'crs.opt.edu.masters':            'Master\'s or professional degree',
    'crs.opt.edu.phd':                'Doctorate (Ph.D.)',
    'crs.opt.lang.fr':                'French (NCLC / TEF / TCF scores)',
    'crs.opt.lang.en':                'English (CLB / IELTS / CELPIP scores)',
    'crs.opt.clb.4less':              'CLB 4 or less',
    'crs.opt.clb.10plus':             'CLB 10 or more',
    'crs.opt.sl.no':                  'No — I am not declaring a second language',
    'crs.opt.sl.yes':                 'Yes — I am declaring my second language',
    'crs.opt.forexp.3plus':           '3 years or more',
    'crs.opt.spouse.edu.none':        'Less than high school diploma',
    'crs.opt.spouse.edu.sec':         'High school diploma',
    'crs.opt.spouse.edu.post1':       'Post-secondary — 1 year',
    'crs.opt.spouse.edu.post2':       'Post-secondary — 2 years',
    'crs.opt.spouse.edu.bac':         'Bachelor\'s degree (3 years or more)',
    'crs.opt.spouse.edu.two':         'Two or more degrees (at least one 3 years+)',
    'crs.opt.spouse.edu.masters':     'Master\'s degree',
    'crs.opt.spouse.edu.phd':         'Doctorate',
    'crs.opt.spouse.none':            'None',
    'crs.opt.spouse.clb.9plus':       'CLB 9 or more',
    'crs.opt.studies.none':           'No studies in Canada',
    'crs.opt.studies.1to2':           'Diploma or certificate of 1 or 2 years (+15 pts)',
    'crs.opt.studies.3plus':          'Degree of 3 years+, master\'s, doctorate or professional degree (+30 pts)',

    // ── DEMANDE DE CITOYENNETE page ──────────────────────────────────────────
    'cit.page.title':   'Canadian Citizenship Application — MDPL Immigration | Naturalization and Exam',
    'cit.bc.current':   'Canadian Citizenship Application',
    'cit.hero.eyebrow': 'IRCC · Canadian Citizenship',
    'cit.hero.title':   'Canadian Citizenship <em>Application</em>',
    'cit.hero.subtitle':'From permanent resident to citizen: know the steps, avoid the pitfalls.',
    'cit.hero.desc':    'Canadian citizenship is the culmination of the immigration journey for thousands of permanent residents each year. MDPL Immigration accompanies you in preparing a solid application and getting ready for the citizenship test.',
    'cit.intro.lead':   'Becoming a Canadian citizen means acquiring the right to vote, consular protection abroad, one of the world\'s most powerful passports — and the security of a permanent status, with no obligation to renew your permanent resident card.',
    'cit.intro.p1':     'Canadian citizenship is obtained through naturalization when a permanent resident meets the conditions set out in the Citizenship Act. The process is administered by Immigration, Refugees and Citizenship Canada (IRCC) and includes several steps: verifying eligibility, submitting the application, a citizenship test, language assessment, and an official ceremony.',
    'cit.intro.p2':     'Although the process is accessible, many applicants make avoidable mistakes — particularly in calculating days of physical presence or in preparing for the test. This page guides you through each step and flags the most common pitfalls.',
    'cit.admi.h2':      'Eligibility requirements for Canadian citizenship',
    'cit.admi.p1':      'To be eligible for Canadian citizenship through naturalization, you must generally meet all of the following conditions:',
    'cit.admi.ul':      '<li>Hold <strong>permanent resident</strong> status in Canada;</li><li>Have been physically present in Canada for at least <strong>1,095 days in the five years</strong> preceding the application date;</li><li>Have filed your <strong>income tax returns</strong> for the years you were required to do so;</li><li>Not be subject to an <strong>inadmissibility finding</strong> or an enforceable removal order;</li><li>Not have been convicted of a criminal offence in the <strong>three years preceding the application</strong>;</li><li>Have <strong>adequate knowledge</strong> of French or English (for applicants aged 18 to 54);</li><li>Have <strong>knowledge of Canada</strong>: history, values, institutions, rights and responsibilities of citizens.</li>',
    'cit.admi.p2':      'Time spent in Canada before permanent residence: days spent in Canada before obtaining permanent residence (as a visitor, student, or temporary worker) may count as half-days in the 1,095-day calculation, up to a maximum of 365 days.',
    'cit.info1.title':  'Not to be confused: naturalization and citizenship by descent',
    'cit.info1.p':      'This page covers citizenship through <strong>naturalization</strong>, obtained after a period of permanent residence in Canada. Citizenship by <strong>descent</strong> is transmitted to a child born abroad to at least one Canadian citizen parent, without any residency requirement. These two paths are governed by separate rules and should not be confused.',
    'cit.depot.h2':     'Submitting a citizenship application',
    'cit.depot.p':      'The citizenship application is submitted online through the IRCC portal. Here are the main elements required to put together a complete file:',
    'cit.f1.title':     'Application form',
    'cit.f1.desc':      'Form CIT 0002 (for adults) or CIT 0003 (for minors included in a parent\'s application) must be filled out carefully and completely. Errors or omissions can cause delays or refusal.',
    'cit.f2.title':     'Documented physical presence',
    'cit.f2.desc':      'You must document every trip outside Canada over the past five years: exact entry and exit dates, destinations, and reasons. IRCC has an online calculator to validate your count before submitting.',
    'cit.f3.title':     'Processing fees',
    'cit.f3.desc':      'Government fees are $630 per adult and $100 per minor (under 18) included in a parent\'s application. These amounts may change — check the IRCC website for current rates.',
    'cit.f4.title':     'Income tax returns',
    'cit.f4.desc':      'You must prove that you filed your income tax returns for all years during which you were required to do so within the five-year reference period. A notice of assessment can serve as proof.',
    'cit.f5.title':     'Identity photos',
    'cit.f5.desc':      'Two identity photos meeting IRCC standards (precise dimensions, white background, taken by a professional photographer). Check current requirements before having them taken.',
    'cit.f6.title':     'Proof of status',
    'cit.f6.desc':      'Permanent resident card, or any other document required by IRCC according to the application instructions in effect at the time of submission.',
    'cit.info2.title':  'The most costly mistake: not using the IRCC calculator',
    'cit.info2.p':      'Many applicants mentally estimate they have accumulated enough days of presence — and submit an application that is later refused. IRCC requires a precise count of every departure from Canada over the past five years. Use the <a href="https://eservices.cic.gc.ca/rescalc/resCalcStartNew.do?lang=en" target="_blank" rel="noreferrer">official physical presence calculator</a> before submitting your application. A refusal for insufficient presence results in loss of processing fees.',
    'cit.prep.h2':      'Preparing for the citizenship test',
    'cit.prep.p1':      'The citizenship test evaluates your knowledge of Canada: history, values, institutions, rights and responsibilities of citizens. The main resource is the official guide <em>Discover Canada</em>, published by IRCC and freely available online.',
    'cit.prep.p2':      'The topics covered by the test include:',
    'cit.prep.ul':      '<li>Indigenous peoples of Canada;</li><li>Canadian history, from Confederation to the present day;</li><li>Canadian government: federal, provincial, and municipal;</li><li>Rights and responsibilities of Canadian citizens;</li><li>National symbols and the geography of Canada.</li>',
    'cit.prep.btn':     'Test your knowledge for free',
    'cit.exam.h2':      'How the citizenship test works',
    'cit.exam.p1':      'The citizenship test consists of 20 multiple-choice questions. A minimum score of 15 correct answers out of 20 (75%) is required to pass. The test lasts 30 minutes and is generally held in person at a local IRCC office.',
    'cit.exam.p2':      'If you fail, you have the opportunity to retake the test. A second failure results in a summons to a hearing before a citizenship judge, who will review your file in person. Applicants under 18 or over 54 are exempt from the test but may still be summoned to a hearing.',
    'cit.lang.h2':      'Language requirements',
    'cit.lang.p1':      'For applicants aged 18 to 54 at the time of application, proof of proficiency in one of Canada\'s official languages is required. The minimum level corresponds to the Canadian Language Benchmarks (CLB) or Niveaux de compétence linguistique canadiens (NCLC) level 4, in all four skills: listening, speaking, reading, and writing.',
    'cit.lang.p2':      'Accepted forms of proof include:',
    'cit.lang.ul':      '<li>Results of a language test recognized by IRCC (TEF Canada, TCF Canada, IELTS, CELPIP);</li><li>A diploma or transcript from a Canadian educational institution offering instruction in French or English;</li><li>Proof of participation in a government-funded official language training program;</li><li>Language test results previously submitted with an approved immigration application.</li>',
    'cit.apres.h2':     'After passing the test',
    'cit.apres.p':      'Once you have passed the test, IRCC reviews your complete file. If everything is in order, you will receive a summons to a citizenship ceremony. The time between passing the test and the ceremony varies depending on your region and the volume of applications being processed.',
    'cit.ceremony.h2':  'The citizenship ceremony',
    'cit.ceremony.p':   'The citizenship ceremony is the official moment when you take the Oath of Citizenship. It is usually held in the presence of a citizenship judge or authorized officer, alongside other new citizens. Virtual ceremonies have also been available since 2020. At the end of the ceremony, you surrender your permanent resident card and receive your citizenship certificate.',
    'cit.cert.h2':      'The citizenship certificate',
    'cit.cert.p':       'The citizenship certificate is official proof of your new status. It is given to you at the ceremony or sent by mail. Keep it in a safe place: it will be required for any passport application and may be requested during administrative procedures.',
    'cit.passeport.h2': 'Applying for a Canadian passport',
    'cit.passeport.p':  'Once you become a citizen, you are eligible for a Canadian passport, which gives visa-free access to more than 180 countries. Applications are made through Service Canada or a Passport Canada office, independently of IRCC. You will need your citizenship certificate, two compliant photos, and the appropriate application form.',
    'cit.info3.title':  'Manage your expectations: realistic processing times',
    'cit.info3.p':      'Official processing times published by IRCC for a complete citizenship application are approximately <strong>12 to 27 months</strong>. These times cover the entire process: initial processing, summons to the test, and ceremony. Check the <a href="https://www.canada.ca/en/immigration-refugees-citizenship/services/application/check-processing-times.html" target="_blank" rel="noreferrer">IRCC website</a> for current times, as they fluctuate regularly.',
    'cit.btn.test':     'Test your citizenship knowledge',
    'cit.btn.rdv':      'Book an Appointment',
    'cit.cta.title':    'Ready to start your <em>citizenship process</em>?',
    'cit.cta.desc':     'Our consultants verify your eligibility, calculate your physical presence days, and prepare a strong file to maximize your chances of success.',
    'cit.meta.desc':    'Everything about the Canadian citizenship application: eligibility requirements, calculating 1,095 days of physical presence, citizenship test, ceremony, and passport. MDPL Immigration, Laval.',
    ...
    'outils.prep.title':      'Complete Exam Preparation',
    'outils.prep.desc':       'Over 200 questions covering the entire official Discover Canada guide, spread across all chapters. 3 months of access to prepare in depth. $19.99 + taxes.',
    'outils.prep.cta':        'Start My Preparation',
    'outils.valeurs.title':   'Quebec Values Preparation',
    'outils.valeurs.desc':    'Study guide, flashcards and 50 practice questions for the attestation of democratic and Quebec values required by the MIFI. Free.',
    'outils.valeurs.cta':     'Start Preparation',
    'outils.infobox.title':   'About These Tools',
    ...
    'blog.art10.tag': 'Detention',
    'blog.art10.title': 'Immigration Detention in Canada: the Detention Review and the Admissibility Hearing',
    'blog.art10.excerpt': 'Being detained by the CBSA or receiving a notice of an admissibility hearing is stressful &mdash; but these procedures are strictly governed by law. Timelines of 48&nbsp;h, 7 days, 30 days, grounds for detention, bond and alternatives: a complete overview.',
    'blog.art10.kw1': 'immigration detention',
    'blog.art10.kw2': 'detention review',
    'blog.art10.kw3': 'CBSA',
    'blog.art11.tag': 'Immigration Appeals (IAD)',
    'blog.art11.title': 'Appealing an Immigration Decision: A Guide to the Immigration Appeal Division (IAD)',
    'blog.art11.excerpt': 'Sponsorship refusal, removal order, loss of permanent resident status: who can appeal to the IAD, what are the strict deadlines, and what is really at stake at a de novo hearing.',
    'blog.art11.kw1': 'immigration appeal',
    'blog.art11.kw2': 'IAD — IRB',
    'blog.art11.kw3': 'sponsorship',
    'blog.art12.tag': 'Asylum Claim',
    'blog.art12.title': 'Claiming Asylum in Canada: The Complete Guide (Updated 2026)',
    'blog.art12.excerpt': 'Convention refugee, IRPA s. 97, STCA, BOC form, RPD and RAD: what every asylum claimant in Canada must know before taking the first step.',
    'blog.art12.kw1': 'asylum claim',
    'blog.art12.kw2': 'RPD — IRB',
    'blog.art12.kw3': 'STCA',
    'blog.art13.tag': 'Humanitarian (H&C)',
    'blog.art13.title': 'Humanitarian and Compassionate Applications: The Complete Guide',
    'blog.art13.excerpt': 'Section 25(1) IRPA, the Kanthasamy test, best interests of the child, one-year bar after a refugee refusal: the H&C guide for anyone who doesn\'t fit a regular immigration category.',
    'blog.art13.kw1': 'H&C application',
    'blog.art13.kw2': 'Kanthasamy',
    'blog.art13.kw3': 'best interests of child',
    'blog.art14.tag': 'Common Mistakes',
    'blog.art14.title': 'The 6 Most Common Mistakes in an Immigration Application (and How to Avoid Them)',
    'blog.art14.excerpt': 'Inconsistent forms, LICO threshold, dual intent, misrepresentation, Super Visa insurance, biometrics: the most frequent pitfalls before submission — and how to avoid them.',
    'blog.art14.kw1': 'immigration mistakes',
    'blog.art14.kw2': 'Super Visa LICO',
    'blog.art14.kw3': 'misrepresentation',
    'blog.faq.eyebrow': 'Frequently asked questions',
    ...
    'outils.cit.title':     'Canadian Citizenship Application',
    'outils.cit.desc':      'Complete guide on the Canadian citizenship application: eligibility requirements, calculating 1,095 days, citizenship test, ceremony, and passport.',
    'outils.cit.cta':       'Read the guide',
    ...
    // ── ARTICLE: PSTQ volets et pointage (Page 1) ───────────────────────────
    'art.pstq.page.title':   'PSTQ: understanding the 4 streams and your score | MDPL Immigration',
    'art.pstq.bc.current':   'Quebec Immigration',
    'art.pstq.cat1':         'Quebec Immigration',
    'art.pstq.hero.title':   'PSTQ: understanding the <em>4 streams</em> and your score',
    'art.pstq.hero.lead':    'The Quebec Skilled Worker Program (PSTQ) selects candidates through Arrima using a points-based system. Understanding its 4 streams and selection logic is the first step toward submitting a strong profile and pursuing your CSQ.',
    'art.pstq.h2.1':         'Understanding the PSTQ',
    'art.pstq.p1':           'The Quebec Skilled Worker Program (PSTQ) is Quebec\'s main economic immigration program for foreign workers. It leads to the <strong>Quebec Selection Certificate (CSQ)</strong>, the mandatory first step toward permanent residence for those wishing to settle in Quebec.',
    'art.pstq.p2':           'The process works in three stages: you submit an <strong>expression of interest</strong> in the Arrima online system; your profile is evaluated and ranked using a points system; the Ministry of Immigration, Francization and Integration (MIFI) then invites targeted profiles, by stream and according to its priorities.',
    'art.pstq.pullquote':    'The PSTQ does not work as an open competition: MIFI issues targeted invitations, by stream and according to ministerial priorities. A strong profile starts with understanding which stream you fall under.',
    'art.pstq.h2.2':         'The <em>4 streams</em> of the PSTQ',
    'art.pstq.p3':           'The PSTQ is divided into four streams, each targeting a different worker profile. It is important to identify the stream that matches your profession and situation before submitting your expression of interest in Arrima.',
    'art.pstq.v1.num':       'Stream 1',
    'art.pstq.v1.title':     'High skills and specialized expertise',
    'art.pstq.v1.desc':      'Professions classified FEER 0, 1 or 2 (management, business, sciences, arts, etc.).',
    'art.pstq.v2.num':       'Stream 2',
    'art.pstq.v2.title':     'Intermediate and manual skills',
    'art.pstq.v2.desc':      'Professions classified FEER 3, 4 or 5 (trades, transport, sales, services, etc.).',
    'art.pstq.v3.num':       'Stream 3',
    'art.pstq.v3.title':     'Regulated professions',
    'art.pstq.v3.desc':      'Professions reserved for members of a Quebec professional order (physicians, engineers, lawyers, etc.).',
    'art.pstq.v4.num':       'Stream 4',
    'art.pstq.v4.title':     'Exceptional talent',
    'art.pstq.v4.desc':      'Rare profiles with very high integration potential and exceptional value for Quebec.',
    'art.pstq.info1.title':  'French: a requirement in every stream',
    'art.pstq.info1.p':      'French is an eligibility requirement for all PSTQ streams. Thresholds vary by stream: for example, Stream 1 generally requires level 7 in oral and 5 in written; Stream 2 requires level 5 in oral. These levels are measured using the Quebec Scale of Language Proficiency in French (EQNCF).',
    'art.pstq.h2.3':         'The <em>PSTQ</em> scoring logic',
    'art.pstq.p4':           'The PSTQ selection system awards points based on several main factors. These factors allow MIFI to rank profiles in Arrima and identify candidates who best match Quebec\'s needs.',
    'art.pstq.p5':           'The main scoring factors are:',
    'art.pstq.li1':          '<strong>Knowledge of French</strong>: language level is one of the most important scoring factors.',
    'art.pstq.li2':          '<strong>Education</strong>: your level of studies and the equivalency of your diploma with the Quebec system.',
    'art.pstq.li3':          '<strong>Work experience</strong>: your years of experience in your qualifying field.',
    'art.pstq.li4':          '<strong>Age</strong>: your age at the time of submitting your expression of interest.',
    'art.pstq.li5':          '<strong>Adaptation factors</strong>: presence in Quebec, education in Quebec, family in Quebec, knowledge of English, among others.',
    'art.pstq.li6':          '<strong>Validated job offer</strong>: a job offer meeting MIFI\'s criteria significantly increases the score.',
    'art.pstq.alert.title':  'A high score does not guarantee an invitation',
    'art.pstq.alert.p':      'MIFI invites profiles in a targeted manner, by stream and according to its current priorities. Even with a high score, an invitation is not guaranteed: MIFI decides how many people are invited, which streams are targeted, and when invitations are issued. It is therefore important to keep your Arrima profile up to date and follow invitation rounds.',
    'art.pstq.h2.4':         'Estimate your score and <em>next steps</em>',
    'art.pstq.p6':           'Before submitting your expression of interest in Arrima, it is useful to estimate your score and check your eligibility for the stream that applies to you.',
    'art.pstq.card1.title':  'Estimate your score',
    'art.pstq.card1.desc':   'MIFI offers a free official self-assessment tool, provided for informational purposes. It lets you estimate your score before submitting your expression of interest in Arrima.',
    'art.pstq.card1.btn':    'Access the official MIFI tool',
    'art.pstq.card2.title':  'Your file deserves a professional review',
    'art.pstq.card2.desc':   'A tool gives you a number. Your file — your background, your documents, your strategy — deserves personalized analysis from a recognized consultant.',
    'art.pstq.card2.btn':    'Personalized assessment — book an appointment',
    'art.pstq.link2.title':  'Did you receive an invitation in Arrima?',
    'art.pstq.link2.p':      'If MIFI has invited you to submit a permanent selection application, the next steps are strictly framed. Deadlines, documents, and required formats: find out what you must do upon receiving your invitation.',
    'art.pstq.link2.btn':    'Read: PSTQ invitation — deadlines and documents',
    'art.pstq.note.title':   'MDPL Immigration — General Information',
    'art.pstq.note.p':       'The information in this article is provided for general and informational purposes only. Immigration programs and their requirements may change. If you have doubts about your situation or eligibility, consult the official MIFI website or contact MDPL Immigration for a personalized assessment.',
    'art.pstq.related.h2':   'Related articles',
    'art.pstq.rel1.tag':     'Quebec Immigration',
    'art.pstq.rel1.title':   'You were selected in the PSTQ: deadlines and documents to provide',
    'art.pstq.rel2.tag':     'Quebec Immigration',
    'art.pstq.rel2.title':   'What is the CSQ? The Quebec Selection Certificate explained',
    'art.pstq.rel3.tag':     'Blog',
    'art.pstq.rel3.title':   'View all articles on the MDPL Immigration blog',

    // ── ARTICLE: Invitation PSTQ delais et documents (Page 2) ───────────────
    'art.invpstq.page.title':    'PSTQ invitation (Arrima): deadlines and documents to provide | MDPL Immigration',
    'art.invpstq.bc.current':    'Quebec Immigration',
    'art.invpstq.cat1':          'Quebec Immigration',
    'art.invpstq.hero.title':    'You were selected in the PSTQ: <em>deadlines and documents</em> to provide',
    'art.invpstq.hero.lead':     'Being selected in the PSTQ means receiving, in your Arrima account, an invitation from MIFI to submit a permanent selection application. After a waiting period in the candidate pool, this invitation triggers strict deadlines you must meet.',
    'art.invpstq.h2.1':          'What happens when you are <em>invited</em>?',
    'art.invpstq.p1':            'When MIFI selects you from the Arrima candidate pool, an official invitation appears in your Arrima account. This invitation asks you to submit a permanent selection application within the specified deadlines.',
    'art.invpstq.alert1.title':  'Arrima is your only communication channel with MIFI',
    'art.invpstq.alert1.p1':     'All MIFI communications regarding your invitation — including requests for additional documents and decisions — go exclusively through your Arrima account. You must log in regularly to avoid missing any communication.',
    'art.invpstq.h2.2':          'The <em>deadlines</em> to respect',
    'art.invpstq.p2':            'Upon receiving your invitation in Arrima, two important deadlines apply. These deadlines are stated in your invitation letter; follow the exact dates mentioned in it.',
    'art.invpstq.step1.title':   'days to ACCEPT the invitation',
    'art.invpstq.step1.desc':    'You must access your Arrima account and confirm that you wish to proceed with the invitation by submitting a permanent selection application.',
    'art.invpstq.step2.title':   'days to submit your complete application',
    'art.invpstq.step2.desc':    'You must submit your complete permanent selection application, with all required documents and payment of fees, within the deadline stated in your Arrima invitation letter.',
    'art.invpstq.alert2.title':  'Warning: consequences of not responding',
    'art.invpstq.alert2.p1':     'If you do not respond to the invitation within the allotted time, your invitation will be withdrawn and your expression of interest will be removed from the Arrima pool. You will have to restart the entire process from scratch.',
    'art.invpstq.h2.3':          'The importance of <em>document formatting</em>',
    'art.invpstq.p3':            'The quality and compliance of your documents is as important as their content. MIFI has precise requirements regarding accepted formats, required copies, and translations.',
    'art.invpstq.li1':           '<strong>Certified copies</strong>: some documents must be certified true copies of the original, as per MIFI\'s instructions.',
    'art.invpstq.li2':           '<strong>Certified translations</strong>: any document in a language other than French or English must be accompanied by a translation certified by an accredited translator.',
    'art.invpstq.li3':           '<strong>Accepted formats</strong>: digital documents must comply with the file formats and maximum sizes indicated in Arrima\'s instructions.',
    'art.invpstq.pullquote':     'A missing, incomplete, or improperly formatted document can delay the processing of your application or jeopardize your entire file. It is best to review each document carefully before submitting.',
    'art.invpstq.h2.4':          'Important: an invitation does not guarantee the CSQ',
    'art.invpstq.p4':            'Receiving an invitation in Arrima is a key step, but it does not constitute an acceptance decision. After your application is submitted, MIFI conducts a full review of your file against the criteria of the Quebec Skilled Worker Program.',
    'art.invpstq.p5':            'Your application may be refused even if you were invited, particularly if information is missing, if your eligibility is not confirmed upon review, or if your file does not meet the requirements of the relevant stream.',
    'art.invpstq.link1.title':   'Understanding the PSTQ and its 4 streams',
    'art.invpstq.link1.p':       'Before submitting your expression of interest in Arrima, it is essential to understand which stream applies to you and how the PSTQ scoring works. Find all the explanations in our dedicated article.',
    'art.invpstq.link1.btn':     'Read: PSTQ — the 4 streams and scoring',
    'art.invpstq.cta.title':     'Did you receive an invitation?',
    'art.invpstq.cta.p':         'Arrima deadlines are strict and your file leaves no room for error. A recognized MDPL Immigration consultant can review your invitation, identify the required documents, and verify your file before submission.',
    'art.invpstq.cta.btn':       'Book an appointment with an MDPL consultant',
    'art.invpstq.note.title':    'MDPL Immigration — General Information',
    'art.invpstq.note.p':        'The information in this article is provided for general and informational purposes only. Immigration programs, deadlines, and document requirements may change. If you have doubts about your situation or your invitation, consult the official MIFI website or contact MDPL Immigration for a personalized assessment.',
    'art.invpstq.related.h2':    'Related articles',
    'art.invpstq.rel1.tag':      'Quebec Immigration',
    'art.invpstq.rel1.title':    'PSTQ: understanding the 4 streams and your score',
    'art.invpstq.rel2.tag':      'Blog',
    'art.invpstq.rel2.title':    'View all articles on the MDPL Immigration blog',
    'art.invpstq.rel3.tag':      'Our Services',
    'art.invpstq.rel3.title':    'Permanent residence — how we can help you',

    // ── BLOG CARDS: art15 (PSTQ volets) + art16 (invitation PSTQ) ───────────
    'blog.art15.tag':     'Immigration Québec',
    'blog.art15.title':   'PSTQ: understanding the 4 streams and your score',
    'blog.art15.excerpt': 'The PSTQ selects skilled workers wishing to settle in Quebec through Arrima. Discover the 4 streams, the scoring logic, and what a strong profile looks like.',
    'blog.art15.kw1':     'PSTQ',
    'blog.art15.kw2':     'Quebec immigration',
    'blog.art15.kw3':     'Arrima',
    'blog.art16.tag':     'Immigration Québec',
    'blog.art16.title':   'PSTQ invitation (Arrima): deadlines and documents to provide',
    'blog.art16.excerpt': 'Selected in the PSTQ? You have 30 days to accept and 60 days to submit your complete file. Deadlines, required documents, and formats accepted by MIFI.',
    'blog.art16.kw1':     'PSTQ invitation',
    'blog.art16.kw2':     'Arrima deadline',
    'blog.art16.kw3':     'CSQ documents',

    // ── ARTICLE: Demande ATIP et notes SMGC ─────────────────────────────────
    'art.atip.page.title':   'ATIP request: what it is and when to file one (especially after a refusal) | MDPL Immigration',
    'art.atip.bc.current':   'Canadian Immigration',
    'art.atip.cat1':         'Canadian Immigration',
    'art.atip.hero.title':   'What is an ATIP request and when to file one<br /><em>(especially after a refusal)</em>',
    'art.atip.hero.lead':    'After an immigration refusal, the letter you receive is often vague and generic. An ATIP request lets you obtain the internal notes in your file — and therefore understand the real reasons behind the decision.',
    'art.atip.h2.1':         'What is an <em>ATIP request</em>?',
    'art.atip.p1':           'ATIP stands for <strong>"Access to Information and Privacy"</strong>. It is a request that allows you to obtain a copy of the information in your immigration file held by IRCC.',
    'art.atip.p2':           'The most useful element is the <strong>GCMS notes</strong> — Global Case Management System notes. These are the internal notes written by the officer who processed your file: their analysis, observations, concerns, and the reasons that led to their decision.',
    'art.atip.pullquote':    'The refusal letter rarely explains why. The GCMS notes show what the officer really thought about your file.',
    'art.atip.h2.2':         'When to file an <em>ATIP request</em>?',
    'art.atip.p3':           'An ATIP request is especially recommended <strong>after a refusal</strong>. IRCC\'s refusal letter is often generic and does not specify the officer\'s reasoning. The GCMS notes reveal the precise grounds that led to the decision — which is essential for deciding on next steps: a new application, reconsideration, or an appeal.',
    'art.atip.p4':           'An ATIP request can also be useful in other situations:',
    'art.atip.li1':          'To <strong>understand an unusual processing delay</strong> and see where your file stands.',
    'art.atip.li2':          'To <strong>see what is missing from your file</strong> or identify a problem before a decision is made.',
    'art.atip.li3':          'To <strong>track the processing of your application</strong> and the steps already completed.',
    'art.atip.h2.3':         'What will you find in it?',
    'art.atip.p5':           'Documents obtained through an ATIP request may include:',
    'art.atip.li4':          '<strong>The officer\'s notes (GCMS)</strong>: their analysis of the file, their concerns, and the detailed reasons for the decision.',
    'art.atip.li5':          '<strong>The admissibility and eligibility assessment</strong>: the criteria examined and the officer\'s conclusions.',
    'art.atip.li6':          '<strong>The processing history and status</strong>: the steps completed, processing dates, and the file\'s current status.',
    'art.atip.li7':          '<strong>Correspondence and documents on file</strong>: recorded exchanges and documents registered by IRCC.',
    'art.atip.h2.4':         'Who can file one, <em>and how</em>?',
    'art.atip.p6':           'The basic rule depends on your status and location at the time of the request:',
    'art.atip.li8':          '<strong>You are a Canadian citizen, permanent resident, or you are in Canada</strong>: you can file the request yourself, free of charge, through the online ATIP request portal on Canada.ca.',
    'art.atip.li9':          '<strong>You are abroad and are neither a citizen nor a permanent resident</strong>: a representative or a person in Canada can file the request on your behalf, with your written consent.',
    'art.atip.info.title':   'What you will need',
    'art.atip.info.li1':     'Your identity information (name, date of birth, nationality)',
    'art.atip.info.li2':     'Your IRCC file number and/or your UCI (Unique Client Identifier)',
    'art.atip.info.li3':     'A Canada.ca account (or your representative\'s contact information in Canada)',
    'art.atip.cta.h3':       'Did you receive a refusal? <em>Understand it before acting.</em>',
    'art.atip.cta.p':        'GCMS notes are a valuable tool, but interpreting them correctly — and deciding on the best course of action — requires expertise. At MDPL Immigration, we analyze your file and help you prepare the best strategy after a refusal.',
    'art.atip.cta.btn1':     'Book an appointment',
    'art.atip.cta.btn2':     'Contact us',
    'art.atip.note.title':   'MDPL Immigration — Immigration Consulting Firm',
    'art.atip.note.p':       'The information in this article is provided for general and informational purposes only. Each immigration file is unique and rules may change. If you have doubts about your situation, consult the official IRCC website or contact MDPL Immigration for a personalized assessment.',
    'art.atip.related.h2':   'Related articles',
    'art.atip.rel1.tag':     'Common Mistakes',
    'art.atip.rel1.title':   'The 6 most common errors in an immigration application (and how to avoid them)',
    'art.atip.rel2.tag':     'Documents',
    'art.atip.rel2.title':   'The importance of submitting documents on time in Canadian immigration',
    'art.atip.rel3.tag':     'Blog',
    'art.atip.rel3.title':   'View all articles on the MDPL Immigration blog',

    // ── BLOG CARD: art17 (ATIP) ──────────────────────────────────────────────
    'blog.art17.tag':     'Immigration canadienne',
    'blog.art17.title':   'What is an ATIP request and when to file one (especially after a refusal)',
    'blog.art17.excerpt': 'After a refusal, IRCC\'s letter is often vague. An ATIP request gives you access to the officer\'s internal notes (GCMS notes) — essential for understanding the real reasons behind the decision.',
    'blog.art17.kw1':     'ATIP request',
    'blog.art17.kw2':     'GCMS notes',
    'blog.art17.kw3':     'immigration refusal',

    // ── ARTICLE: Entrevue parrainage époux ──────────────────────────────────
    'art.entrevue.page.title':  'Spousal sponsorship interview: what to expect (with sample questions) | MDPL Immigration',
    'art.entrevue.bc.current':  'Family Sponsorship',
    'art.entrevue.cat1':        'Family Sponsorship',
    'art.entrevue.cat2':        'IRCC Interview',
    'art.entrevue.hero.title':  'Spousal sponsorship interview:<br /><em>what to expect (with sample questions)</em>',
    'art.entrevue.hero.lead':   'As part of a spousal or conjugal sponsorship application, IRCC may invite the couple to an interview. The purpose: to verify that your relationship is genuine and in good faith, and not an arrangement for immigration purposes. This is not systematic — an interview is generally requested when the officer needs clarification or has doubts.',
    'art.entrevue.h2.1':        'What to expect <em>at the interview</em>',
    'art.entrevue.li1':         'The interview may take place <strong>in person</strong> (at an immigration office or visa application centre), or sometimes by <strong>telephone or video conference</strong>.',
    'art.entrevue.li2':         'The couple may be <strong>interviewed separately</strong>, with their answers compared afterward to check for consistency.',
    'art.entrevue.li3':         'Bring: your <strong>passport</strong>, the <strong>convocation letter</strong>, and your <strong>proof of relationship</strong> (photos, communications, proof of cohabitation, joint finances, etc.).',
    'art.entrevue.li4':         'The officer is primarily assessing the <strong>consistency and naturalness of your answers</strong>. Be honest — inconsistencies raise suspicions.',
    'art.entrevue.li5':         'It is normal to be nervous; the officer knows this.',
    'art.entrevue.pullquote':   'The officer is not trying to trap you. They are trying to confirm that your relationship is real. Consistency and honesty are your best assets.',
    'art.entrevue.h2.2':        'Sample questions <em>(for reference)</em>',
    'art.entrevue.p1':          'Questions asked during a sponsorship interview cover three main themes: your history together, your daily life, and your plans for the future. The following are representative examples, provided for reference only.',
    'art.entrevue.h3.1':        'Your meeting and your story',
    'art.entrevue.q1':          'How and where did you meet? When?',
    'art.entrevue.q2':          'When did your relationship begin? When did you get married?',
    'art.entrevue.q3':          'Tell me about your first meeting, your marriage proposal, your wedding (date, location, guests).',
    'art.entrevue.h3.2':        'Your daily life',
    'art.entrevue.q4':          'What does your spouse do for work? What are their hobbies?',
    'art.entrevue.q5':          'Describe your home. Who takes care of what around the house?',
    'art.entrevue.q6':          'What did you do together last weekend?',
    'art.entrevue.q7':          'What is your spouse\'s favourite dish?',
    'art.entrevue.h3.3':        'Your family and your future',
    'art.entrevue.q8':          'Tell me about your spouse\'s family (names, relationships).',
    'art.entrevue.q9':          'Do you have children? Are you planning to have children?',
    'art.entrevue.q10':         'What are your plans for the future together?',
    'art.entrevue.alert.title': 'Inconsistent answers are taken seriously',
    'art.entrevue.alert.p':     'When both partners are interviewed separately, their answers are compared. Significant discrepancies on concrete facts (dates, places, events) may raise doubts about the authenticity of the relationship. Make sure both partners are well acquainted with the important facts.',
    'art.entrevue.h2.3':        'How to <em>prepare</em>',
    'art.entrevue.prep1':       'Review your own application before the interview.',
    'art.entrevue.prep2':       'Do not memorize answers "by heart" — be natural and honest.',
    'art.entrevue.prep3':       'Make sure both partners are well acquainted with the important facts (dates, events).',
    'art.entrevue.prep4':       'Prepare and bring your documents (passport, convocation letter, proof of relationship).',
    'art.entrevue.cta.h3':      'Did you receive a convocation? <em>Prepare with a professional.</em>',
    'art.entrevue.cta.p':       'A sponsorship interview can feel stressful, but good preparation makes a real difference. At MDPL Immigration, we support couples in preparing their file and their interview.',
    'art.entrevue.cta.btn1':    'Book an appointment',
    'art.entrevue.cta.btn2':    'Contact us',
    'art.entrevue.note.title':  'MDPL Immigration — Immigration Consulting Firm',
    'art.entrevue.note.p':      'The information in this article is provided for general and informational purposes only. The sample questions are indicative and IRCC practices may vary. Each file is unique. If you have doubts about your situation, contact MDPL Immigration for a personalized assessment.',
    'art.entrevue.related.h2':  'Related articles',
    'art.entrevue.rel1.tag':    'Family Sponsorship',
    'art.entrevue.rel1.title':  'He lives in Ontario, works in Quebec: a sponsorship file that almost went off the rails',
    'art.entrevue.rel2.tag':    'Common Mistakes',
    'art.entrevue.rel2.title':  'The 6 most common errors in an immigration application (and how to avoid them)',
    'art.entrevue.rel3.tag':    'Blog',
    'art.entrevue.rel3.title':  'View all articles on the MDPL Immigration blog',

    // ── BLOG CARD: art18 (entrevue parrainage) ───────────────────────────────
    'blog.art18.tag':     'Parrainage familial',
    'blog.art18.title':   'Spousal sponsorship interview: what to expect (with sample questions)',
    'blog.art18.excerpt': 'IRCC may invite a couple to an interview to verify the authenticity of their relationship. What to expect, sample questions, and tips to prepare.',
    'blog.art18.kw1':     'sponsorship interview',
    'blog.art18.kw2':     'genuine relationship',
    'blog.art18.kw3':     'IRCC interview questions',

    // ── article-depute-aide-dossier-immigration.html ──
    'art.depute.page.title':    'How a Member of Parliament can help with your immigration file — and what they can\'t do | MDPL Immigration',
    'art.depute.bc.current':    'Canadian Immigration',
    'art.depute.cat1':          'Canadian Immigration',
    'art.depute.cat2':          'IRCC • Member of Parliament',
    'art.depute.hero.title':    'How a Member of Parliament can help with your immigration file — <em>and what they can\'t do</em>',
    'art.depute.hero.lead':     'When an immigration file is delayed or seems stuck, many wonder whether their MP can intervene. A federal Member of Parliament can take steps with IRCC on your behalf, but their role has important limits to know.',
    'art.depute.h2.1':          'What an MP <em>CAN do</em>',
    'art.depute.li1':           'Submit an <strong>information or status request</strong> about your file to IRCC on your behalf. You will generally need to live in their constituency.',
    'art.depute.li2':           '<strong>Flag an abnormal processing delay</strong> or an urgent or humanitarian situation, and draw IRCC\'s attention to your file.',
    'art.depute.li3':           '<strong>Request an explanation</strong> for a delay or the current status of a file.',
    'art.depute.li4':           'Their office often has <strong>staff dedicated to constituent casework</strong>, who communicate directly with IRCC on your behalf.',
    'art.depute.pullquote':     'An MP can open a door, draw attention to an unusual delay, or flag an urgent situation — they cannot decide in place of IRCC.',
    'art.depute.h2.2':          'What an MP <em>CANNOT do</em>',
    'art.depute.li5':           '<strong>Approve, deny, or influence the decision</strong> on your file: the IRCC officer remains solely responsible for the outcome.',
    'art.depute.li6':           '<strong>Speed up or guarantee faster processing</strong>, or move you ahead of other applicants.',
    'art.depute.li7':           '<strong>Provide legal immigration advice</strong> or represent you: that is the role of an authorized representative — a regulated consultant (RCIC) or a lawyer.',
    'art.depute.li8':           '<strong>Intervene for someone outside their constituency</strong>: their mandate is limited to residents of their own electoral district.',
    'art.depute.alert.title':   'Do not confuse an MP\'s inquiry with professional representation',
    'art.depute.alert.p':       'An MP can ask questions of IRCC, but cannot analyze your file, assess your legal options, prepare an application, or represent you. For a strategy tailored to your situation, a regulated consultant or immigration lawyer is the right professional.',
    'art.depute.h2.3':          'Key <em>takeaways</em>',
    'art.depute.li9':           'You will normally need to <strong>sign a consent form</strong> so the MP\'s office can inquire with IRCC on your behalf.',
    'art.depute.li10':          'Immigration is a <strong>federal</strong> jurisdiction: it is your <strong>federal MP</strong> who can intervene with IRCC.',
    'art.depute.li11':          '<strong>In Quebec</strong>, for matters relating to provincial selection — the CSQ or MIFI — it is a <strong>provincial elected official</strong> (Member of the National Assembly) who can intervene with MIFI.',
    'art.depute.li12':          'An MP is a <strong>complement</strong> to, not a substitute for, professional immigration support.',
    'art.depute.cta.h3':        'Is your file stuck or delayed? <em>Let\'s review it together.</em>',
    'art.depute.cta.p':         'An MP\'s follow-up can complement your approach, but it does not replace a professional review of your file. At MDPL Immigration, we assess your situation, identify blockers, and guide you toward the right solutions.',
    'art.depute.cta.btn1':      'Book a consultation',
    'art.depute.cta.btn2':      'Contact us',
    'art.depute.note.title':    'MDPL Immigration — Immigration consulting firm',
    'art.depute.note.p':        'The information in this article is provided for general informational purposes only. Procedures and practices are subject to change. Each case is unique. If you have questions about your situation, contact MDPL Immigration for a personalized assessment.',
    'art.depute.related.h2':    'Related articles',
    'art.depute.rel1.tag':      'Canadian Immigration',
    'art.depute.rel1.title':    'What is an ATIP request and when to file one (especially after a refusal)',
    'art.depute.rel2.tag':      'Documents',
    'art.depute.rel2.title':    'The importance of submitting your documents on time in Canadian immigration',
    'art.depute.rel3.tag':      'Blog',
    'art.depute.rel3.title':    'See all articles on the MDPL Immigration blog',

    // ── blog card art19 ──
    'blog.art19.tag':     'Canadian Immigration',
    'blog.art19.title':   'How a Member of Parliament can help with your immigration file — and what they can\'t do',
    'blog.art19.excerpt': 'A federal MP can make inquiries to IRCC about a delayed or stalled file — but their role has important limits to know. What they can do, and what they cannot.',
    'blog.art19.kw1':     'Member of Parliament immigration',
    'blog.art19.kw2':     'MP help immigration case',
    'blog.art19.kw3':     'IRCC processing delay',

    // ── article-biometrie-portail-vfs.html ──
    'art.bio.page.title':    'Biometrics: what to do when VFS does not respond — the portal option | MDPL Immigration',
    'art.bio.bc.current':    'Canadian Immigration',
    'art.bio.cat1':          'Canadian Immigration',
    'art.bio.cat2':          'Biometrics • VFS',
    'art.bio.hero.title':    'Biometrics: what to do when VFS does not respond — <em>the portal option</em>',
    'art.bio.hero.lead':     'If VFS Global does not respond by phone or email to schedule your biometrics appointment, the VFS portal is the solution. Here are the steps to follow and the critical points not to miss.',
    'art.bio.h2.1':          'How to use the VFS portal to schedule your <em>biometrics appointment</em>',
    'art.bio.p.intro':       'When VFS Global does not respond by phone or email, the online portal is the recommended solution. Follow these steps in order:',
    'art.bio.s1.title':      'Download your biometrics letter (summons)',
    'art.bio.s1.text':       'In the portal, first download your biometrics letter — the summons sent by IRCC. Save it to your computer.',
    'art.bio.s1.warn':       'DO NOT rename the document as downloaded. The original file name is required for the portal to recognize your file.',
    'art.bio.s2.title':      'Upload the letter to the portal',
    'art.bio.s2.text':       'Upload the letter into the portal. Your information (full name and file number) will fill in automatically from the document.',
    'art.bio.s3.title':      'Add the missing information',
    'art.bio.s3.text':       'Complete the remaining fields: your email address and phone number.',
    'art.bio.s3.warn':       'IMPORTANT — Phone number: no dashes, no spaces. Enter only the digits run together (e.g., 5141234567). An incorrect format may block your request.',
    'art.bio.s4.title':      'Provide three available dates',
    'art.bio.s4.text':       'Propose three dates on which you are available for your biometrics appointment. Choose realistic and varied dates to make scheduling easier.',
    'art.bio.s5.title':      'Confirmation email',
    'art.bio.s5.text':       'You will receive a confirmation email from VFS within a maximum of 2 hours. In practice, the reply often arrives sooner.',
    'art.bio.s5.info':       'Check your spam folder if you receive nothing within 2 hours.',
    'art.bio.h2.2':          'What to bring <em>on the day of your appointment</em>',
    'art.bio.bring.p':       'On the day of your VFS appointment, you must bring the following two documents:',
    'art.bio.li1':           '<strong>The biometrics request (summons) — 9-page document</strong>: this is the official document received from IRCC asking you to provide your biometric data.',
    'art.bio.li2':           '<strong>Your valid passport</strong>: original identification required for fingerprinting and photo.',
    'art.bio.alert.title':   'Warning — both documents are mandatory',
    'art.bio.alert.p':       'Without the 9-page document AND your passport, you will be turned away and will need to rebook an appointment. Do not show up without both documents.',
    'art.bio.cta.h3':        'A file in progress, questions about next steps? <em>We can guide you.</em>',
    'art.bio.cta.p':         'Biometrics are part of a larger process. At MDPL Immigration, we accompany each step of your file to avoid mistakes and delays.',
    'art.bio.cta.btn1':      'Book a consultation',
    'art.bio.cta.btn2':      'Contact us',
    'art.bio.note.title':    'MDPL Immigration — Immigration consulting firm',
    'art.bio.note.p':        'The information in this article is provided for general informational purposes only. VFS and IRCC procedures are subject to change. If you have questions about your situation, contact MDPL Immigration for a personalized assessment.',
    'art.bio.related.h2':    'Related articles',
    'art.bio.rel1.tag':      'Canadian Immigration',
    'art.bio.rel1.title':    'What is an ATIP request and when to file one (especially after a refusal)',
    'art.bio.rel2.tag':      'Documents',
    'art.bio.rel2.title':    'The importance of submitting your documents on time in Canadian immigration',
    'art.bio.rel3.tag':      'Blog',
    'art.bio.rel3.title':    'See all articles on the MDPL Immigration blog',

    // ── blog card art20 ──
    'blog.art20.tag':     'Canadian Immigration',
    'blog.art20.title':   'Biometrics: what to do when VFS does not respond — the portal option',
    'blog.art20.excerpt': 'VFS Global not responding? Use the VFS portal to schedule your biometrics appointment. Step-by-step guide and what to bring on the day.',
    'blog.art20.kw1':     'biometrics VFS',
    'blog.art20.kw2':     'VFS portal appointment',
    'blog.art20.kw3':     'IRCC biometrics',

    // ── article-suivi-demande-recu-paiement.html ──
    'art.suivi.page.title':    'Confirm receipt of your application and track your file using the payment receipt number | MDPL Immigration',
    'art.suivi.bc.current':    'Canadian Immigration',
    'art.suivi.cat1':          'Canadian Immigration',
    'art.suivi.cat2':          'IRCC • File tracking',
    'art.suivi.hero.title':    'Confirm receipt of your application and find your file using the <em>payment receipt number</em>',
    'art.suivi.hero.lead':     'You sent your immigration application by registered mail and have not heard from IRCC? Here is how to confirm your application is in processing and how to get your file number.',
    'art.suivi.h2.1':          'Steps to confirm receipt and <em>track your application</em>',
    'art.suivi.p.intro':       'These steps apply to applications sent by registered mail — work permits, study permits, temporary residence, and other paper applications submitted to IRCC.',
    'art.suivi.s1.title':      'Keep a complete record of your application',
    'art.suivi.s1.text':       'Before sending anything, keep a copy of your entire application and note in a log: the date of mailing, the contents, and the postal tracking number.',
    'art.suivi.s2.title':      'Send by registered mail',
    'art.suivi.s2.text':       'Sending by registered mail generates a tracking number. This postal tracking confirms delivery of your application to IRCC — it is your first proof of receipt.',
    'art.suivi.s3.title':      'No acknowledgment of receipt from IRCC is normal',
    'art.suivi.s3.text':       'With a registered mail submission, you often do not receive a formal acknowledgment of receipt from IRCC — sometimes an email, sometimes nothing.',
    'art.suivi.s3.warn':       'No acknowledgment of receipt does not mean your file is not in processing. This is normal for paper applications.',
    'art.suivi.s4.title':      'You need your file number to use the IRCC webform',
    'art.suivi.s4.text':       'To follow up via the IRCC webform or for any official communication, you will need your file number (UCI number or application number). Here is how to get it.',
    'art.suivi.s5.title':      'Get your file number using the payment receipt number',
    'art.suivi.s5.text':       'Call Immigration Canada (IRCC) and provide your <strong>payment receipt number</strong> (the receipt for the application fees paid when you submitted). This is one of the simplest ways to locate your file in their system.',
    'art.suivi.s5.info':       'Keep your payment receipt from day one — it is a key document for any follow-up.',
    'art.suivi.s6.title':      'Identity verification by the IRCC officer',
    'art.suivi.s6.text':       'The officer will ask identity verification questions before sharing any information about your file. It is the payment receipt number that allows them to locate your application in their system.',
    'art.suivi.s7.title':      'The final decision usually arrives by email',
    'art.suivi.s7.text':       'Once your application has been processed, the final decision (approval or refusal) is generally communicated by email. Make sure your email address is correct and check your spam folder as well.',
    'art.suivi.info.title':    'About the IRCC webform',
    'art.suivi.info.p':        'The IRCC webform is the official online tool for submitting an inquiry about your file. To use it, you will need your file number or UCI number. If you do not have them yet, use the phone call first (step 5) to obtain them.',
    'art.suivi.cta.h3':        'No news from your file for several months? <em>Let\'s see what can be done.</em>',
    'art.suivi.cta.p':         'Proactive follow-up is essential to prevent your file from stalling without reason. At MDPL Immigration, we know the official channels and the steps to take to move your file forward.',
    'art.suivi.cta.btn1':      'Book a consultation',
    'art.suivi.cta.btn2':      'Contact us',
    'art.suivi.note.title':    'MDPL Immigration — Immigration consulting firm',
    'art.suivi.note.p':        'The information in this article is provided for general informational purposes only. IRCC procedures are subject to change. If you have questions about your situation, contact MDPL Immigration for a personalized assessment.',
    'art.suivi.related.h2':    'Related articles',
    'art.suivi.rel1.tag':      'Canadian Immigration',
    'art.suivi.rel1.title':    'How a Member of Parliament can help with your immigration file — and what they can\'t do',
    'art.suivi.rel2.tag':      'Canadian Immigration',
    'art.suivi.rel2.title':    'What is an ATIP request and when to file one (especially after a refusal)',
    'art.suivi.rel3.tag':      'Blog',
    'art.suivi.rel3.title':    'See all articles on the MDPL Immigration blog',

    // ── blog card art21 ──
    'blog.art21.tag':     'Canadian Immigration',
    'blog.art21.title':   'Confirm receipt of your application and track your file using the payment receipt number',
    'blog.art21.excerpt': 'No acknowledgment of receipt from IRCC? That\'s normal for registered mail. Here\'s how to confirm your application is in processing and get your IRCC file number.',
    'blog.art21.kw1':     'IRCC application tracking',
    'blog.art21.kw2':     'payment receipt number',
    'blog.art21.kw3':     'IRCC file number',

    // ── article-etudier-canada-permis-etudes-exemptions.html ──
    'art.etudes.page.title':        'Who can study in Canada with or without a study permit? Rules, exemptions and special cases | MDPL Immigration',
    'art.etudes.bc.current':        'Canadian Immigration',
    'art.etudes.cat1':              'Canadian Immigration',
    'art.etudes.cat2':              'Study Permit • IRCC',
    'art.etudes.hero.title':        'Who can study in Canada <em>with or without a study permit?</em>',
    'art.etudes.hero.lead':         'The answer depends on your status in Canada, the length of the program, and your specific situation. Complete guide: general rule, short-term exemption, temporary policy for work permit holders, asylum claimants, and minor children — with a summary table and legal references.',
    'art.etudes.h2.1':              'The general rule',
    'art.etudes.p1':                'A study permit is required for any program of <strong>more than 6 months</strong> offered by a <strong>designated learning institution (DLI)</strong>. This includes not only university and college programs, but also <strong>vocational and technical training</strong> — any structured program delivered by a DLI that exceeds 6 months in duration. The conditions for issuance of a study permit are set out in section 216 IRPR.',
    'art.etudes.h2.2':              'The short-term studies exemption (6 months or less) — <em>s. 188 IRPR</em>',
    'art.etudes.s2.p1':             'Any person with <strong>valid status</strong> in Canada may follow a program of <strong>6 months or less without a study permit</strong>, provided the program is completed before the end of their authorized period of stay.',
    'art.etudes.s2.who.title':      'Who can use this exemption',
    'art.etudes.s2.li1':            'Visitors (with valid status — visitor visa, eTA, or visitor record)',
    'art.etudes.s2.li2':            'Work permit holders with valid status',
    'art.etudes.s2.li3':            'Any other temporary resident with valid status in Canada',
    'art.etudes.pullquote':         'Essential condition: the program must be <strong>completed before your authorized period of stay expires</strong>. If your status expires before the end of the course, the exemption does not apply.',
    'art.etudes.h2.3':              'Temporary policy for work permit holders — <em>s. 25.2 IRPA</em>',
    'art.etudes.alert.title':       'Warning — expires June 27, 2026. No extension announced.',
    'art.etudes.alert.p1':          'This public interest policy ends on <strong>June 27, 2026</strong>. No extension has been announced by IRCC as of the publication date of this article (June 2026).',
    'art.etudes.alert.p2':          'After that date, work permit holders who do not qualify under the general exemption may only study without a study permit for programs of <strong>6 months or less</strong>. Studying beyond 6 months without a study permit will be unauthorized.',
    'art.etudes.s3.p1':             'This public interest policy, issued under section 25.2 IRPA, allows certain work permit holders to study in Canada without a study permit, <strong>regardless of program length</strong>, during the policy\'s validity period.',
    'art.etudes.s3.crit.title':     'Eligibility requirements',
    'art.etudes.s3.crit.li1':       'Your <strong>initial</strong> work permit application was <strong>received by IRCC on or before June 7, 2023</strong>, OR',
    'art.etudes.s3.crit.li2':       'You <strong>renewed</strong> your work permit under section 201 IRPR, that renewal application was received on or before June 7, 2023, and you are authorized to work under section 186(u) IRPR.',
    'art.etudes.s3.period.title':   'Policy validity period',
    'art.etudes.s3.period.p':       'June 27, 2023 to <strong>June 27, 2026</strong>.',
    'art.etudes.s3.ret.title':      'Key points',
    'art.etudes.s3.ret.li1':        'No extension of this policy has been announced as of this date.',
    'art.etudes.s3.ret.li2':        'After June 27, 2026, the <strong>general rule resumes</strong>: programs of 6 months or less only, without a study permit.',
    'art.etudes.s3.ret.li3':        'Studies completed without a study permit <strong>do not count toward the PGWP</strong> (Post-Graduation Work Permit).',
    'art.etudes.s3.ret.li4':        'Studying without authorization after the expiry date may <strong>jeopardize your status</strong> in Canada.',
    'art.etudes.h2.4':              'Asylum claimants — <em>a special and counter-intuitive case</em>',
    'art.etudes.s4.p1':             'Most asylum claimants do <strong>not have temporary resident status</strong> or a formal authorized period of stay. The 6-month exemption (s. 188 IRPR) is therefore generally <strong>not available</strong> to them.',
    'art.etudes.s4.p2':             'As a result, <strong>a study permit is required even for a short course</strong>.',
    'art.etudes.s4.info.title':     'Good news',
    'art.etudes.s4.info.p':         'Asylum claimants may apply for a study permit <strong>from within Canada</strong>, under section 215 IRPR, without having to leave the country. They are also <strong>exempt from the biometrics requirement</strong> for this specific application.',
    'art.etudes.s4.cas.title':      'Two situations to distinguish',
    'art.etudes.s4.cas.a':          '<strong>(a) Asylum claimant WITHOUT temporary resident status</strong> → study permit required, even for a short program (s. 215 IRPR).',
    'art.etudes.s4.cas.b':          '<strong>(b) Asylum claimant who held valid temporary resident status</strong> at the time of filing their asylum claim → may use the 6-month exemption (s. 188 IRPR) if all conditions are met.',
    'art.etudes.s4.note.p':         'Note: certain work permits issued to asylum claimants carry the notation <em>"does not confer temporary resident status (s. 202 IRPR)."</em> This type of permit <strong>does not authorize studying without a study permit</strong>.',
    'art.etudes.h2.5':              'Minor children — <em>s. 30(2) IRPA</em>',
    'art.etudes.s5.p':              'Under section 30(2) of IRPA, minor children may attend <strong>kindergarten, elementary school, and secondary school</strong> in Canada <strong>without a study permit</strong>, regardless of their immigration situation.',
    'art.etudes.h2.6':              'Summary table',
    'art.etudes.tbl.h1':            'Situation',
    'art.etudes.tbl.h2':            'Study permit required?',
    'art.etudes.tbl.h3':            'Legal basis',
    'art.etudes.tbl.r1.s':          'Program of more than 6 months at a DLI',
    'art.etudes.tbl.r1.p':          'Yes',
    'art.etudes.tbl.r1.l':          'IRPA + s. 216 IRPR',
    'art.etudes.tbl.r2.s':          'Program of 6 months or less, valid status, completed before end of authorized stay',
    'art.etudes.tbl.r2.p':          'No',
    'art.etudes.tbl.r2.l':          'S. 188 IRPR',
    'art.etudes.tbl.r3.s':          'Work permit holder (application received on or before June 7, 2023) — before June 27, 2026',
    'art.etudes.tbl.r3.p':          'No (regardless of program length)',
    'art.etudes.tbl.r3.l':          'S. 25.2 IRPA',
    'art.etudes.tbl.r4.s':          'Asylum claimant without temporary resident status',
    'art.etudes.tbl.r4.p':          'Yes (even for a short course)',
    'art.etudes.tbl.r4.l':          'S. 215 IRPR (application from within Canada)',
    'art.etudes.tbl.r5.s':          'Asylum claimant with valid TR status at the time of filing',
    'art.etudes.tbl.r5.p':          'No (if program ≤ 6 months)',
    'art.etudes.tbl.r5.l':          'S. 188 IRPR',
    'art.etudes.tbl.r6.s':          'Minor child (kindergarten, elementary, or secondary school)',
    'art.etudes.tbl.r6.p':          'No',
    'art.etudes.tbl.r6.l':          'S. 30(2) IRPA',
    'art.etudes.cta.h3':            'Is your situation complex? <em>Let\'s review it together.</em>',
    'art.etudes.cta.p':             'Whether you need a study permit, an exemption applies to your case, you are an asylum claimant wanting to study in Canada, or a policy is about to expire — the rules are precise and the consequences of an error can be lasting. MDPL Immigration will clarify your situation and guide you toward the right steps.',
    'art.etudes.cta.btn1':          'Book a consultation',
    'art.etudes.cta.btn2':          'Contact us',
    'art.etudes.note.title':        'MDPL Immigration — Immigration consulting firm',
    'art.etudes.note.p':            'The information in this article is provided for general informational purposes only, based on IRCC policies and Canadian immigration law as of June 2026. Rules and procedures are subject to change. Each case is unique. This content does not replace personalized advice from a Regulated Canadian Immigration Consultant (RCIC) or a lawyer.',
    'art.etudes.related.h2':        'Related articles and services',
    'art.etudes.rel1.tag':          'MDPL Services',
    'art.etudes.rel1.title':        'Study permit — support and applications',
    'art.etudes.rel2.tag':          'Canadian Immigration',
    'art.etudes.rel2.title':        'Biometrics: what to do when VFS does not respond — the portal option',
    'art.etudes.rel3.tag':          'Blog',
    'art.etudes.rel3.title':        'See all articles on the MDPL Immigration blog',

    // ── blog card art22 ──
    'blog.art22.tag':     'Immigration canadienne',
    'blog.art22.title':   'Qui peut étudier au Canada avec ou sans permis d\'études ? Règles, exemptions et cas particuliers',
    'blog.art22.excerpt': 'Permis d\'études obligatoire ou non ? Exemption pour programmes de 6 mois ou moins, politique temporaire pour permis de travail (expire le 27 juin 2026), demandeurs d\'asile et enfants mineurs — guide complet avec tableau.',
    'blog.art22.kw1':     'permis d\'études',
    'blog.art22.kw2':     'exemption études Canada',
    'blog.art22.kw3':     'politique temporaire permis travail',
    'blog.art26.tag':     'International Students',
    'blog.art26.title':   'Work permit for destitute student (R208a): the little-known lifeline when everything falls apart',
    'blog.art26.excerpt': 'A little-known measure for the international student whose financial situation collapses for reasons beyond their control.',
    'blog.art26.kw1':     'student work permit',
    'blog.art26.kw2':     'section 208 R208',
    'blog.art26.kw3':     'international student',

    // Article R208a translations (EN)
    'art.r208.page.title': 'Destitute Student Work Permit (R208(a)): the little-known lifeline when everything falls apart | MDPL Immigration',
    'art.r208.hero.title': 'Work permit for destitute <em>student</em> (R208a):<br />the little-known lifeline when everything falls apart',
    'art.r208.hero.lead': 'You arrived in Canada with a solid plan, then overnight, everything falls apart. A death, a bankruptcy, a disaster, a crisis. Canadian law provides a specific measure for this situation: the destitute student work permit, set out in paragraph 208(a) of the Immigration and Refugee Protection Regulations.',

    // ── MON PROGRAMME (page de choix) ──
    'mp.hero.eyebrow': 'Your space',
    'mp.hero.title':   'My preparation program for <em>Canadian citizenship</em>',
    'mp.hero.sub':     'Welcome. Choose where to begin your preparation.',
    'mp.prog.title':   'Your progress',
    'mp.prog.txt':     'Progress: 0% &middot; Start whenever you are ready.',
    'mp.c1.title':     'Study the guide',
    'mp.c1.l1':        '12 chapters',
    'mp.c1.l2':        'Summaries and key points',
    'mp.c1.l3':        'Mini-quiz per chapter',
    'mp.c1.btn':       'Start the guide',
    'mp.c2.title':     'Flashcards',
    'mp.c2.l1':        '48 memory cards',
    'mp.c2.l2':        'Practice alone or with family',
    'mp.c2.btn':       'Practice the cards',
    'mp.c3.title':     'Go to the questions',
    'mp.c3.l1':        '250 questions',
    'mp.c3.l2':        'Simulated exams',
    'mp.c3.btn':       'Start the questions',
    'mp.c4.title':     'Quick review',
    'mp.c4.l1':        '20 essential facts',
    'mp.c4.l2':        'Review before the exam',
    'mp.c4.btn':       'Quick review',
    'mp.signout':      'Sign out',

    // ── FLASHCARDS ──
    'fc.hero.eyebrow': 'Practice',
    'fc.hero.title':   'Memory <em>cards</em>',
    'fc.hero.sub':     'Practice alone or with family. Click a card to reveal the answer.',
    'fc.intro':        '48 cards covering the entire official guide. A good way to review: ask the question out loud, answer, then click to check.',
    'fc.shuffle':      'Shuffle the cards',
    'fc.showall':      'Show all (questions)',
    'fc.back':         'Back to my program',

    // ── CONNEXION ──
    'cx.hero.eyebrow': 'Preparation program',
    'cx.hero.title':   'Access your <em>study space</em>',
    'cx.hero.sub':     'Log in or create an account to access your program.',
    'cx.tab.login':    'Log in',
    'cx.tab.signup':   'Create an account',
    'cx.submit':       'Log in',
    'cx.note':         'Important: use the <strong>same email</strong> for your account and for payment, so that your access is activated automatically.',
    'cx.active.title': 'Access active',
    'cx.active.text':  'Your access is active. Redirecting to your program…',
    'cx.active.btn':   'Access the program',
    'cx.exp.title':    'Your access is not active',
    'cx.exp.text':     'Your access is not active or has expired. To access the full program (250 questions, 3-month access), proceed to payment below. Your access will activate automatically after payment.',
    'cx.exp.btn':      'Buy 3-month access ($19.99)',
    'cx.signout':      'Sign out',

    // -- PROGRAMME-PREPARATION (landing) --
    'pp.bc': 'Preparation program',
    'pp.hero.eyebrow': 'Complete program',
    'pp.hero.title': 'Prepare for your <em>citizenship</em> exam',
    'pp.hero.sub': 'Everything you need to succeed, in one program.',
    'pp.intro': 'The Canadian citizenship exam tests your knowledge of Canada\'s history, geography, government, and symbols. Our program prepares you thoroughly, at your own pace, with an interactive study guide and a complete bank of practice questions.',
    'pp.inc.title': 'What you get',
    'pp.inc.1': 'Over 250 practice questions covering the entire official Discover Canada guide',
    'pp.inc.2': 'Questions evenly distributed across all chapters',
    'pp.inc.3': 'An interactive study guide organized into 12 chapters',
    'pp.inc.4': 'Memory cards (flashcards) to memorize key concepts',
    'pp.inc.5': 'Mini-quizzes after each chapter, with immediate correction',
    'pp.inc.6': 'An interactive timeline of Canadian history',
    'pp.inc.7': '"Key takeaways" and "Common mistakes" callout boxes',
    'pp.inc.8': 'A quick review mode before the exam',
    'pp.inc.9': 'A preparation report and a certificate of completion',
    'pp.inc.10': 'Full access for 3 months (90 days)',
    'pp.why.title': 'Why this program?',
    'pp.f1.t': 'Learn first',
    'pp.f1.p': 'Study every concept in the official guide through a clear path, without long blocks of text that are hard to remember.',
    'pp.f2.t': 'Then practice',
    'pp.f2.p': 'Test your knowledge with over 250 questions similar to those on the real exam.',
    'pp.f3.t': 'Target your weaknesses',
    'pp.f3.p': 'Your subject-by-subject report shows you exactly which topics to review first.',
    'pp.f4.t': 'Prepared by experts',
    'pp.f4.p': 'Designed by MDPL Immigration, an immigration consulting firm established in Laval since 2015.',
    'pp.how.title': 'How it works',
    'pp.s1': 'You complete the payment securely.',
    'pp.s2': 'You create your account with the same email.',
    'pp.s3': 'You access the guide and the 250 questions for 3 months.',
    'pp.price.eyebrow': 'Full 3-month access',
    'pp.price.sub': 'One-time payment &middot; Access for 90 days',
    'pp.continue': 'If you wish to continue, click below:',
    'pp.cta': 'Start my preparation'
  };
  ...
  var TT = [
    ...
    { fr: 'Test de citoyenneté (essai gratuit)',  en: 'Citizenship Test (free trial)' },
    { fr: 'Demande de citoyenneté', en: 'Citizenship Application' },
    { fr: 'Assistant immigration', en: 'Immigration Assistant' },
    { fr: 'Programme préparatoire à l\'examen',  en: 'Exam Preparation Program' },
    { fr: 'Préparation aux valeurs québécoises (gratuit)', en: 'Quebec Values Preparation (free)' },
  ...
  // GA4 — clic sur un bouton Prendre RDV (tous liens Setmore, toutes pages)
  document.addEventListener('click', function (e) {
    var link = e.target.closest('a[href*="setmore.com"]');
    if (link && typeof gtag === 'function') {
      gtag('event', 'book_appointment_click');
    }
  });

  // Bug 2 — masque le bouton FR/EN au defilement sur mobile (max-width: 768px)
  (function () {
